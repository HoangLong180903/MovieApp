...
import com.example.mvptutotial.models.TopRatedModels.TopRatedModel;
...
public class TopRatedAdapter extends RecyclerView.Adapter<TopRatedAdapter.MyViewHolder> {
    ...
    public TopRatedAdapter(Context mContext, List<TopRatedModel> list) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        TopRatedModel results = list.get(position);
